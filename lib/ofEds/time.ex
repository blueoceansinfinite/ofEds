defmodule OfEds.Time do
  @second_ms 1_000_000

  @doc """
  Examples

    iex> OfEds.Time.to_timestamp(%DateTime{calendar: Calendar.ISO, day: 7, hour: 16, microsecond: {321, 6}, minute: 13, month: 11, second: 19, std_offset: 0, time_zone: "Etc/UTC", utc_offset: 0, year: 2015, zone_abbr: "UTC"})
    1446912799.000321
  """
  ...
  Examples
    ...
    iex> OfEds.Time.to_datetime(1446912799.000321)
    ...
    iex> OfEds.Time.to_datetime(1446912799)
  ...
  # iex> OfEds.Time.to_naive_datetime(1446912799.000321)
